                    ...
                    <div className="row">
                        ...
                        <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                            <div className="stockCounter d-inline">
								...
								<span className="btn btn-primary plus" onClick={()=> incereaseQty(item)}>+</span>
                            </div>
                        </div>

                        <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                            <i id="delete_cart_item" className="fa fa-trash btn btn-danger"onClick={()=>removeItem(item)}>DELETE</i>
                        </div>
